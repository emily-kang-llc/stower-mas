...
/// gear menu (the Application Window's `Window` scene) writes the desired tab
/// before calling `openSettings()`, and `StowerSettingsView`'s
/// `TabView(selection:)` (the `Settings` scene) reads it.
